...
{!! Form::open(['action'=>'CompanyController@store','method'=>'POST','class'=>'container','enctype'=>'multipart/form-data']) !!}
<h1 class="align-items-center"> New Company Form</h1>
{{-- name input --}}
...
<div class=" form-group row">
    ...
    <div class="col-sm-10">
        {!! Form::url('website', "", ['class'=>'form-control','placeholder'=>'Enter website']) !!}
    </div>
</div>
{{-- logo Input --}}
<div class=" form-group row">
